...
public class DynamicObject extends haxe.lang.HxObject
{
	...
	{
		//line 42 "C:\\Motion-Twin\\Haxe\\std\\java\\internal\\HxObject.hx"
	...
	{
		//line 46 "C:\\Motion-Twin\\Haxe\\std\\java\\internal\\HxObject.hx"
		haxe.lang.Function ts = ((haxe.lang.Function) (haxe.lang.Runtime.getField(this, "toString", false)) );
		//line 47 "C:\\Motion-Twin\\Haxe\\std\\java\\internal\\HxObject.hx"
		if (( ts != null )) 
		{
			//line 48 "C:\\Motion-Twin\\Haxe\\std\\java\\internal\\HxObject.hx"
			return haxe.lang.Runtime.toString(ts.__hx_invoke0_o());
		}
		
		//line 49 "C:\\Motion-Twin\\Haxe\\std\\java\\internal\\HxObject.hx"
		haxe.root.StringBuf ret = new haxe.root.StringBuf();
		//line 50 "C:\\Motion-Twin\\Haxe\\std\\java\\internal\\HxObject.hx"
		ret.add(haxe.lang.Runtime.toString("{"));
		//line 51 "C:\\Motion-Twin\\Haxe\\std\\java\\internal\\HxObject.hx"
		boolean first = true;
		//line 52 "C:\\Motion-Twin\\Haxe\\std\\java\\internal\\HxObject.hx"
		{
			//line 52 "C:\\Motion-Twin\\Haxe\\std\\java\\internal\\HxObject.hx"
			int _g = 0;
			//line 52 "C:\\Motion-Twin\\Haxe\\std\\java\\internal\\HxObject.hx"
			...
			while (( _g < _g1.length ))
			{
				...
				//line 52 "C:\\Motion-Twin\\Haxe\\std\\java\\internal\\HxObject.hx"
				 ++ _g;
				//line 54 "C:\\Motion-Twin\\Haxe\\std\\java\\internal\\HxObject.hx"
				if (first) 
				{
					//line 55 "C:\\Motion-Twin\\Haxe\\std\\java\\internal\\HxObject.hx"
					first = false;
				}
				else
				{
					//line 57 "C:\\Motion-Twin\\Haxe\\std\\java\\internal\\HxObject.hx"
					ret.add(haxe.lang.Runtime.toString(","));
				}
				
				//line 58 "C:\\Motion-Twin\\Haxe\\std\\java\\internal\\HxObject.hx"
				ret.add(haxe.lang.Runtime.toString(" "));
				//line 58 "C:\\Motion-Twin\\Haxe\\std\\java\\internal\\HxObject.hx"
				ret.add(haxe.lang.Runtime.toString(f));
				//line 59 "C:\\Motion-Twin\\Haxe\\std\\java\\internal\\HxObject.hx"
				ret.add(haxe.lang.Runtime.toString(" : "));
				//line 60 "C:\\Motion-Twin\\Haxe\\std\\java\\internal\\HxObject.hx"
				ret.add(((java.lang.Object) (haxe.root.Reflect.field(this, f)) ));
			}
			
		}
		
		//line 62 "C:\\Motion-Twin\\Haxe\\std\\java\\internal\\HxObject.hx"
		if ( ! (first) ) 
		{
			//line 62 "C:\\Motion-Twin\\Haxe\\std\\java\\internal\\HxObject.hx"
			ret.add(haxe.lang.Runtime.toString(" "));
		...
		//line 63 "C:\\Motion-Twin\\Haxe\\std\\java\\internal\\HxObject.hx"
		ret.add(haxe.lang.Runtime.toString("}"));
		//line 64 "C:\\Motion-Twin\\Haxe\\std\\java\\internal\\HxObject.hx"
		return ret.toString();
	}
