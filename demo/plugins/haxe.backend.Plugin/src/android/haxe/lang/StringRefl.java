...
public class StringRefl
{
	static
	{
		//line 209 "C:\\Motion-Twin\\Haxe\\std\\java\\internal\\StringExt.hx"
	...
	{
		//line 213 "C:\\Motion-Twin\\Haxe\\std\\java\\internal\\StringExt.hx"
		{
			//line 213 "C:\\Motion-Twin\\Haxe\\std\\java\\internal\\StringExt.hx"
			...
			switch (__temp_hash3)
			{
				case -1106363674:
				{
					...
					if (__temp_svar1.equals("length")) 
					{
						...
						//line 215 "C:\\Motion-Twin\\Haxe\\std\\java\\internal\\StringExt.hx"
						return str.length();
					}
				...
				case -1361633751:
				{
					...
					if (( (( ( __temp_hash3 == -399551817 ) && __temp_svar1.equals("toUpperCase") )) || ( (( ( __temp_hash3 == -1137582698 ) && __temp_svar1.equals("toLowerCase") )) || ( (( ( __temp_hash3 == 530542161 ) && __temp_svar1.equals("substring") )) || ( (( ( __temp_hash3 == -891529231 ) && __temp_svar1.equals("substr") )) || ( (( ( __temp_hash3 == 109648666 ) && __temp_svar1.equals("split") )) || ( (( ( __temp_hash3 == -467511597 ) && __temp_svar1.equals("lastIndexOf") )) || ( (( ( __temp_hash3 == 1943291465 ) && __temp_svar1.equals("indexOf") )) || ( (( ( __temp_hash3 == 397153782 ) && __temp_svar1.equals("charCodeAt") )) || __temp_svar1.equals("charAt") ) ) ) ) ) ) ) )) 
					{
						//line 213 "C:\\Motion-Twin\\Haxe\\std\\java\\internal\\StringExt.hx"
						__temp_executeDef2 = false;
						//line 217 "C:\\Motion-Twin\\Haxe\\std\\java\\internal\\StringExt.hx"
			...
			//line 219 "C:\\Motion-Twin\\Haxe\\std\\java\\internal\\StringExt.hx"
			if (__temp_executeDef2) 
			{
				//line 219 "C:\\Motion-Twin\\Haxe\\std\\java\\internal\\StringExt.hx"
				if (throwErrors) 
				{
					//line 220 "C:\\Motion-Twin\\Haxe\\std\\java\\internal\\StringExt.hx"
					throw haxe.lang.HaxeException.wrap(( ( "Field not found: \'" + f ) + "\' in String" ));
				}
				else
				{
					//line 222 "C:\\Motion-Twin\\Haxe\\std\\java\\internal\\StringExt.hx"
					return null;
				}
	...
	{
		//line 228 "C:\\Motion-Twin\\Haxe\\std\\java\\internal\\StringExt.hx"
		java.lang.Object[] _args = null;
		//line 229 "C:\\Motion-Twin\\Haxe\\std\\java\\internal\\StringExt.hx"
		if (( args == null )) 
		{
			//line 230 "C:\\Motion-Twin\\Haxe\\std\\java\\internal\\StringExt.hx"
			_args = ((java.lang.String[]) (new java.lang.String[]{haxe.lang.Runtime.toString(str)}) );
		}
		else
		{
			//line 232 "C:\\Motion-Twin\\Haxe\\std\\java\\internal\\StringExt.hx"
			_args = new java.lang.Object[( args.length + 1 )];
			//line 233 "C:\\Motion-Twin\\Haxe\\std\\java\\internal\\StringExt.hx"
			_args[0] = str;
			//line 234 "C:\\Motion-Twin\\Haxe\\std\\java\\internal\\StringExt.hx"
			{
				//line 234 "C:\\Motion-Twin\\Haxe\\std\\java\\internal\\StringExt.hx"
				int _g1 = 0;
				//line 234 "C:\\Motion-Twin\\Haxe\\std\\java\\internal\\StringExt.hx"
				...
				while (( _g1 < _g ))
				{
					//line 234 "C:\\Motion-Twin\\Haxe\\std\\java\\internal\\StringExt.hx"
					int i = _g1++;
					//line 235 "C:\\Motion-Twin\\Haxe\\std\\java\\internal\\StringExt.hx"
					_args[( i + 1 )] = args[i];
				}
		...
		//line 237 "C:\\Motion-Twin\\Haxe\\std\\java\\internal\\StringExt.hx"
