...
public class List<T> extends haxe.lang.HxObject
{
	...
	public List()
	{
		//line 43 "C:\\Motion-Twin\\Haxe\\std\\List.hx"
		haxe.root.List.__hx_ctor__List(((haxe.root.List<T>) (this) ));
	}
	
	
	protected static <T_c> void __hx_ctor__List(haxe.root.List<T_c> __hx_this)
	{
		//line 44 "C:\\Motion-Twin\\Haxe\\std\\List.hx"
		__hx_this.length = 0;
	}
	...
	{
		//line 53 "C:\\Motion-Twin\\Haxe\\std\\List.hx"
		_List.ListNode<T> x = new _List.ListNode<T>(item, null);
		//line 54 "C:\\Motion-Twin\\Haxe\\std\\List.hx"
		if (( this.h == null )) 
		{
			//line 55 "C:\\Motion-Twin\\Haxe\\std\\List.hx"
			this.h = x;
		}
		else
		{
			//line 57 "C:\\Motion-Twin\\Haxe\\std\\List.hx"
			this.q.next = x;
		}
		
		//line 58 "C:\\Motion-Twin\\Haxe\\std\\List.hx"
		this.q = x;
		//line 59 "C:\\Motion-Twin\\Haxe\\std\\List.hx"
		this.length++;
	}
	...
	{
		//line 30 "C:\\Motion-Twin\\Haxe\\std\\List.hx"
		{
			//line 30 "C:\\Motion-Twin\\Haxe\\std\\List.hx"
